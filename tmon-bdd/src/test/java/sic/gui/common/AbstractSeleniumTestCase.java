...
//					throw new GUITestRunimeException 할까 디폴트값으로 설정할까...
			...
			if ("local".equalsIgnoreCase(testEnvVar)) {
				...
				System.setProperty("webdriver.ie.driver",
						GUITestUtils.getProjectPath() + "/webdrivers/IEDriverServer.exe");
				System.setProperty("webdriver.chrome.driver",
						GUITestUtils.getProjectPath() + "/webdrivers/chromedriver.exe");
				System.setProperty("webdriver.gecko.driver",
						GUITestUtils.getProjectPath() + "/webdrivers/geckodriver.exe");
				...
				System.setProperty("webdriver.ie.driver",
						GUITestUtils.getProjectPath() + "/webdrivers/IEDriverServer");
				System.setProperty("webdriver.chrome.driver",
						GUITestUtils.getProjectPath() + "/webdrivers/chromedriver");
				System.setProperty("webdriver.gecko.driver",
						GUITestUtils.getProjectPath() + "/webdrivers/geckodriver");

			} else {
				testEnv = TESTENV_DEV;
				System.out.println(
						"Not supported test environment value(should be in ( local / dev / test / prod / maclocal) - "
								+ testEnvVar);
	...
	/**
	 * This will set the basic test requirements like - base url, WebDriver and
	 * NgWebDriver, etc
	 */
	...
	protected void waitForElementPresent(WebElement webElement) throws InterruptedException {
		GUITestUtils.waitForElementPresent(driver, webElement);
	}
	...
	public String getPageTitle() {
		return GUITestUtils.getPageTitle(driver);
	}
